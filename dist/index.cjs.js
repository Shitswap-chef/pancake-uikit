...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Shitswap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/Shitswap-chef/pancake-uikit/blob/master/src/widgets/Menu/logo.png?raw=true", alt: "Shitswap Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/Shitswap-chef/pancake-uikit/blob/master/src/widgets/Menu/shitswap_logo.png?raw=true", alt: "Shitswap Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Shitswap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/Shitswap-chef/pancake-uikit/blob/master/src/widgets/Menu/logo.png?raw=true", alt: "Shitswap Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/Shitswap-chef/pancake-uikit/blob/master/src/widgets/Menu/shitswap_logo.png?raw=true", alt: "Shitswap Logo", className: "desktop-icon" })))));
};
